    ...
    return (
        <Container>
          <Col md="9" className="greetings">
            <h1 className="headline"><Link to="/about"><span id="name">Yurika Jacobsson</span></Link> is a frontend developer located in the Bay Area. <span id="designer">Also a designer</span>.</h1>
