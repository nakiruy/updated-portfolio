    ...
    return (
        <Container>
          <Col md="9" className="greetings">
            <h1 className="headline"><Link to="/about"><span id="name">Yurika Jacobsson</span></Link> is a designer & technical project manager located in the Bay Area. <span id="developer">Also dabbles in code</span>.</h1>
