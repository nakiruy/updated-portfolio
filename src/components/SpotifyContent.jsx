        ...
        <Col className="spotify-process">
          ...
          <Row>
            ...
            <Col lg="8" data-aos="fade-up">
              ...
              Fortunately, solutions for items one and three were clear. An addition of voice functionality for playlist selections and an on/off toggle for Car Mode should solve those issues. However, a solution for issue two was not so apparent because of the wide variety of preferences.<br></br><br></br> 
              After brainstorming and testing out multiple sizes, it was evident that <span className="chunky-underline" id="spotify-underline-color">just simply making buttons bigger is not enough</span>. Instead, I determined that a hands-free, gesture-based would be sufficient to solve item two. This would mean that a user can control playback not only though tactile means but through movement as well.
              </Media>
            </Col>
          </Row>
          <Row>
            ...
            <Col lg="8" data-aos="fade-up">
              ...
              This library can add up to five gesture methods to any Android application: <span className="chunky-underline" id="spotify-underline-color">left</span> (by waving left), <span className="chunky-underline" id="spotify-underline-color">right</span> (by waving right), <span className="chunky-underline" id="spotify-underline-color">up</span> (by waving up), <span className="chunky-underline" id="spotify-underline-color">down</span> (by waving down), and <span className="chunky-underline" id="spotify-underline-color">selection</span> (by hovering a hand over the front camera). With methods established, I each assigned an associated movement for this application:<br></br><br></br>
              ...
              Then I got to the onboarding...<br></br><br></br>
