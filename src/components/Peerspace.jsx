...
class Peerspace extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <div className="main">
            <Container>
              <Col md="9" className="greetings">
                <h1 className="headline" data-aos="fade-up">Welcome to my online cover letter, <span id="cover-letter-name">Peerspace</span>.</h1>
                <div data-aos="fade-up">
                  ...
                  <h6 className="about-desc" id="cover-letter-desc">
                    ...
                    For example, since I am a <span className="chunky-underline">product designer who can code</span>, I have experience in using Sketch, Photoshop, Invision, and proficient with HTML/CSS/JavaScript (in fact, this page is built in React!). 
