...
class Customerio extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <div className="main">
            <Container>
              <Col md="9" className="greetings">
                <h1 className="headline" data-aos="fade-up">Welcome to my online cover letter, <span id="cover-letter-name">Customer.io</span>.</h1>
