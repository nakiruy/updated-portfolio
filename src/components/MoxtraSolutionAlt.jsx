...
class MoxtraSolutionAlt extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {slides}
        <CarouselControl className="prev-arrow" direction="prev" directionText="Previous" onClickHandler={this.previous} />
        <CarouselControl className="next-arrow" direction="next" directionText="Next" onClickHandler={this.next} />
      </Carousel>
    );
  }
}
...
export default MoxtraSolutionAlt;