  ...
  return (
    <Container>
      ...
      <Col className="tapcast-process">
        ...
        <Media body>
          As with any startup, the biggest challenge for this project was the lack of resources. In particular, we were in dire need of engineering resources. With only two full-time developers and one part-time developer, it was a difficult proposition to focus limited engineering resources on the redesigning of the platform (I’ll expand more on this later). In addition, the concepts around the Tapcast platform are complicated and requires a ramp-up period. Why? The purpose of this platform is to provide insights and help demystify your Facebook audiences. Advertising on Facebook can be confusing and complicated (read here, here, here). Without a baseline knowledge of advertising on Facebook, it will be a challenge for any users to understand the purpose of Tapcast. In other words, this product is not for everybody. Then, how do you create a platform that is comprehensive and comprehensible for users - all while keeping in mind of engineering resources? 
